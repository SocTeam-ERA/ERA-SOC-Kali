...
| 003 | [Automated provisioning of a fresh Kali (packages and sensor configuration)](003-automated-provisioning.md) | Done | 2026-09-23 |
| 004 | [Resolve alerts with a note in the platform dashboard, synced back to the Kali](004-resolve-with-note-in-platform.md) | Accepted (Kali side done) | 2026-09-23 |
